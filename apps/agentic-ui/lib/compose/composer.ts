  ...
  try {
    const res = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: "system", content: "You are a food delivery UI composer. Always respond with valid JSON tool calls." },
          { role: "user", content: prompt },
        ],
        tools: [
          { type: "function", function: { name: "restructureHome", description: "Restructure home page layout", parameters: { type: "object", properties: { hero: { type: "object", properties: { title: { type: "string" }, subtitle: { type: "string" }, tag: { type: "string" } } }, rows: { type: "array", items: { type: "object", properties: { title: { type: "string" }, items: { type: "array", items: { type: "object", properties: { name: { type: "string" }, price: { type: "string" }, image: { type: "string" }, badge: { type: "string" } } } } } }, hideDefaultRows: { type: "boolean" } } } },
          { type: "function", function: { name: "showMoodPicker", description: "Show mood picker", parameters: { type: "object", properties: { prompt: { type: "string" }, moods: { type: "array", items: { type: "object", properties: { label: { type: "string" }, icon: { type: "string" }, curatedItems: { type: "array", items: { type: "object", properties: { name: { type: "string" }, price: { type: "string" }, image: { type: "string" } } } } } } } } },
          { type: "function", function: { name: "showContextBanner", description: "Show context banner", parameters: { type: "object", properties: { tone: { type: "string", enum: ["info", "warning", "success"] }, title: { type: "string" }, message: { type: "string" } } } },
          { type: "function", function: { name: "showCuratedRow", description: "Show curated row", parameters: { type: "object", properties: { title: { type: "string" }, tag: { type: "string" }, items: { type: "array", items: { type: "object", properties: { name: { type: "string" }, price: { type: "string" }, image: { type: "string" }, macroBadges: { type: "array", items: { type: "string" } }, priceRange: { type: "string" } } } }, macroBadges: { type: "array", items: { type: "string" } }, priceRange: { type: "string" } } } },
        ],
